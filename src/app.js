...
(function () {
  ...
  function blockToParagraph(el, style) {
    var runs = coalesce(collectRuns(el, { bold: false, italic: false, underline: false, strike: false, code: false }));
  ...
  function coalesce(runs) {
    ...
    // Strip default-false flags to match the wire format (false omitted).
    ...
    return {
      paragraphs: [
        ...
        { style: "Normal", align: "Left", runs: [
          ...
          { text: " to export your work — or just keep writing." }
        ] }
      ]
    };
  }
